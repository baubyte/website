...
// Small floating badges on the Hero's decorative avatar frame.
...
// About sidebar ("Details") icon+data rows.
...
// `skillIcons.js` — a plain code-braces glyph, not a broken/missing icon,
// so an unmapped skill never renders without a visual.
